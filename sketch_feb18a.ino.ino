...
const char* ssid     = "DABADE"; // Your SSID (Name of your WiFi)
const char* password = "9594687497KUSH"; //Your Wifi password

const char* host = "api.thingspeak.com";
String api_key = "9U90KEYRYZX1YA9O"; // Your API Key provied by thingspeak

void setup(){
    Serial.begin(9600);
    Serial.println(F("CropPred"));
    dht.begin();
    Connect_to_Wifi();
}
